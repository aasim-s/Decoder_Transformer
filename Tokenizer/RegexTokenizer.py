...
class RegexTokenizer(Tokenizer):
    ...
    def encode(self, text, allowed_special="none_raise"):
        ...
        Allowed_special: can be "all"|"none"|"none_raise" or a custom dict
        If none_raise, then an error is raised if special token is encountered
        """
        ...
        for part in special_chunks:
            if part in special:
                # special token, encode it separately
                ids.append(special[part])
            else:
                # ordinary sequence, encode it normally
